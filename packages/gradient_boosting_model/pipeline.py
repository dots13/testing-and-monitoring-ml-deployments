    ...
    [
        ...
        (
            ...
            RareLabelEncoder(
                ...
                n_categories=(
                    config.gradient_boosting_model_config.rare_label_n_categories
                ),
                variables=cast(str | list[str | int] | None,
                               config.gradient_boosting_model_config.categorical_vars,)
            ),
        ),
        (
            "categorical_encoder",
